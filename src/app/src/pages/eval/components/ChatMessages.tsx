...
const ChatMessage = memo(({ message }: { message: Message | null }) => {
  ...
  const textColor = isUser || isDark ? '#FFFFFF' : '#2B1449';
      ...
      <Box
        ...
        sx={{
          backgroundColor: (theme) =>
            theme.palette.mode === 'dark' ? 'rgba(43, 20, 73, 0.2)' : '#F8F9FA',
          p: 2,
          borderRadius: 2,
          position: 'relative',
          minHeight,
          ...
          '&::after':
            !isExpanded && hasMoreMessages
              ? {
                  ...
                  right: 0,
                  height: '50px',
                  background: `linear-gradient(to bottom, transparent, ${isDark ? 'rgba(43, 20, 73, 0.2)' : '#F8F9FA'})`,
                  pointerEvents: 'none',
                }
              : {},
        }}
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center' }}>
          <Button
            ...
            sx={{
              ...
              '&:hover': {
                backgroundColor: isDark ? 'rgba(255, 255, 255, 0.05)' : 'rgba(43, 20, 73, 0.05)',
              },
            }}
          >
