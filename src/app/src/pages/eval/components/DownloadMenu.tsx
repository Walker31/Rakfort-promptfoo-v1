      ...
      <Box sx={{ mt: 1.5, mb: 2.5 }}>
        ...
        <Box
          sx={{
            ...
            backgroundColor: isDarkMode ? 'rgba(255, 255, 255, 0.08)' : 'rgba(43, 20, 73, 0.06)',
            border: '1px solid',
            borderColor: isDarkMode ? 'rgba(255, 255, 255, 0.12)' : 'rgba(43, 20, 73, 0.1)',
            borderRadius: 1,
            p: '10px 16px',
        ...
        >
          ...
          <IconButton
            ...
            sx={{
              ...
              backgroundColor: isDarkMode ? 'rgba(43, 20, 73, 0.2)' : 'rgba(255, 255, 255, 0.5)',
              '&:hover': {
                                  backgroundColor: isDarkMode ? 'rgba(43, 20, 73, 0.4)' : 'rgba(255, 255, 255, 0.8)',
              },
              border: '1px solid',
              borderColor: isDarkMode ? 'rgba(255, 255, 255, 0.2)' : 'rgba(43, 20, 73, 0.1)',
            }}
