...
export default function PluginConfigDialog({
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth PaperProps={{ sx: { backgroundColor: '#22103B', color: '#fff', borderColor: 'grey.500', border: 1 } }}>
      <DialogTitle sx={{ backgroundColor: '#22103B', color: '#fff' }}>Configure {plugin}</DialogTitle>
      <DialogContent sx={{ backgroundColor: '#22103B', color: '#fff' }}>{renderConfigInputs()}</DialogContent>
      <DialogActions sx={{ backgroundColor: '#22103B', color: '#fff' }}>
        <Button onClick={onClose} sx={{ color: '#fff', borderColor: '#A259F7', borderRadius: 2, fontWeight: 600, '&:hover': { backgroundColor: '#2B1449', borderColor: '#A259F7', color: '#fff' } }}>Cancel</Button>
        <Button onClick={handleSave} variant="contained" sx={{ backgroundColor: '#A259F7', color: '#fff', borderRadius: 2, fontWeight: 600, '&:hover': { backgroundColor: '#8e3be8' } }}>
          Save
        </Button>
      </DialogActions>
    </Dialog>
