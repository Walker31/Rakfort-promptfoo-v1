      ...
      {selectedTarget.config.request ? (
        ...
        >
          <FormControlLabel
            ...
            label="Use HTTPS"
            sx={{ mb: 2, display: 'block', color: '#fff' }}
          />
          <Editor
        ...
        <Box mt={2} p={2} border={1} borderColor="grey.500" borderRadius={2} sx={{ backgroundColor: '#22103B' }}>
          <TextField
            fullWidth
            label="URL"
          ...
          <FormControl fullWidth margin="normal">
            <InputLabel id="method-label" sx={{ color: '#fff' }}>Method</InputLabel>
            <Select
              labelId="method-label"
              value={selectedTarget.config.method}
              onChange={(e) => updateCustomTarget('method', e.target.value)}
              label="Method"
              sx={{ color: '#fff', backgroundColor: '#2B1449' }}
              MenuProps={{
                PaperProps: {
                  sx: { backgroundColor: '#2B1449', color: '#fff' },
                },
              }}
            >
              {['GET', 'POST'].map((method) => (
                <MenuItem key={method} value={method} sx={{ color: '#fff', backgroundColor: '#2B1449' }}>
                  {method}
                </MenuItem>
              ))}
            </Select>
          ...
          <Button startIcon={<AddIcon />} onClick={addHeader} variant="outlined" sx={{ mt: 1, color: '#fff', borderColor: '#A259F7', borderRadius: '8px', fontWeight: 500, '&:hover': { backgroundColor: '#2B1449', borderColor: '#A259F7', color: '#fff' } }}>
            Add Header
          </Button>
          ...
          <Box
            sx={{
              border: 1,
              borderColor: bodyError ? 'error.main' : 'grey.500',
              mt: 1,
              position: 'relative',
              backgroundColor: '#22103B',
            }}
        ...
        <DialogContent>
          <Grid container spacing={3} sx={{ mt: 1 }}>
            <Grid item xs={12} md={6}>
              ...
              <Paper elevation={3} sx={{ height: '300px', overflow: 'auto', backgroundColor: '#22103B', color: '#fff', borderColor: 'grey.500', border: 1 }}>
                <Editor
                  value={request}
            ...
            {generatedConfig && (
              <Grid item xs={12}>
                ...
                <Paper elevation={3} sx={{ height: '20rem', overflow: 'auto', backgroundColor: '#22103B', color: '#fff', borderColor: 'grey.500', border: 1 }}>
                  <Editor
