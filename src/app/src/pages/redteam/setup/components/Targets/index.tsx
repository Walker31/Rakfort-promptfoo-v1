...
export default function Targets({ onNext, onBack, setupModalOpen }: TargetsProps) {
  ...
  return (
    <div className='bg-[#22103B] m-0 p-0'>
    <Stack direction="column" spacing={3} sx={{backgroundColor: '#22103B'}}>
      <Typography variant="h4" gutterBottom sx={{ fontWeight: 'bold', mb: 3, color: '#fff' }}>
      ...
      <Typography variant="body1" sx={{ color: '#fff' }}>
        ...
        <Link href="https://www.promptfoo.dev/docs/providers/" target="_blank" rel="noopener" sx={{ color: '#fff', textDecoration: 'underline' }}>
      ...
      <Box mb={4}>
        <Typography variant="h5" gutterBottom sx={{ fontWeight: 'medium', mb: 3, color: '#fff' }}>
          Select a Target
        </Typography>
        <Box sx={{ mt: 2, mb: 2 }}>
              ...
              <Box sx={{ flex: 1 }}>
                ...
                >
                  {selectOptions.map((target) => (
                    <MenuItem sx={{backgroundColor: '#2B1449'}} key={target.value} value={target.value}>
                      {target.label}
                    </MenuItem>
                  ))}
                </Select>
        ...
        <TextField
          ...
          slotProps={{
            input: {
              sx: { backgroundColor: '#2B1449' },
              style: { color: '#fff' }, // input value text color
            },
          }}
          label="Target Name"
      ...
      >
        ...
        <Button
          ...
          sx={{
            ...
            px: 4,
            py: 1,
            '&:hover': { backgroundColor: '#2B1449', color: '#fff' },
            '&:disabled': { backgroundColor: '#444', color: '#bbb' },
          }}
        >
          Next
        </Button>
