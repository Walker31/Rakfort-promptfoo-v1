          ...
          Object.keys(ALIASED_PLUGIN_MAPPINGS[framework]).length > 0 ? (
                ...
                ([categoryId, { plugins: categoryPlugins }]) => {
                  ...
                  return (
                    <Box
                      ...
                      mb={2}
                      sx={{
                        border: '1px solid rgba(43, 20, 73, 0.08)',
                        borderRadius: 1,
                        overflow: 'hidden',
                      }}
                    >
                      <Box
                        ...
                        p={1}
                        sx={{
                          bgcolor: 'rgba(43, 20, 73, 0.05)',
                          borderBottom:
                            allCompliant || noTestedPlugins
                              ? 'none'
                              : '1px solid rgba(43, 20, 73, 0.08)',
                        }}
                      >
                        ...
                        {testedPlugins.length === 0 && untestedPlugins.length === 0 ? (
                          ...
                          <Chip
                            ...
                            sx={{
                              backgroundColor:
                                nonCompliantCategoryPlugins.length === 0 ? theme.palette.success.main : theme.palette.error.main,
                              color: 'white',
                              fontSize: '0.7rem',
                              height: 20,
                            }}
            ...
            >
              <Box
                ...
                sx={{
                  bgcolor: 'rgba(43, 20, 73, 0.05)',
                  borderBottom: '1px solid rgba(43, 20, 73, 0.08)',
                }}
              >
